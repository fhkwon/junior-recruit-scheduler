...
- [채용시까지] [한국딥러닝 데이터 엔지니어 채용](https://welcomekdl.oopy.io/#f8ccaa2408d24881a40d073fc3285be8)
  - 한국딥러닝(KDL)은 역사상 가장 유용한 3D asset 마켓플레이스를 만드는 AI 스타트업입니다.
  - 다양한 AI 솔루션 개발에 필요한 데이터 엔지니어링 파이프라인을 직접 설계해보고 싶으신 분을 찾습니다!
